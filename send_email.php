...
if (isset($_POST['submit_email'])) {
    ...
    if (mysqli_num_rows($select) == 1) {
        ...
        $body      = "Dengan Hormat, <br><br>Klik link berikut untuk reset Password, <a href='https://darabakerystore.000webhostapp.com/login/reset_pass.php?reset=$pass&key=$email'>$pass<a><br><br>Salam manis,<br>Dara Bakery"; //isi dari email
        ...
        $mail->SMTPAuth = true;
        // GMAIL username
        $mail->Username = "411212080@mahasiswa.undira.ac.id";
        // GMAIL password
        $mail->Password = "411212080";
        $mail->SMTPSecure = "ssl";
        // sets GMAIL as the SMTP server
        $mail->Host = "smtp.gmail.com";
        // set the SMTP port for the GMAIL server
        $mail->Port = "465";
        $mail->From = '411212080@mahasiswa.undira.ac.id';
