...
<head>
  ...
  <title>Dara Bakery - Reset Password</title>
    ...
    <div class="card">
      <div class="card-body login-card-body">
        ...
        if ($_GET['key'] && $_GET['reset']) {
          ...
          $email = $_GET['key'];
          $pass = $_GET['reset'];
          // Kode yang melibatkan penggunaan $email dan $pass
          $select = mysqli_query($koneksi, "SELECT email,pass FROM akun WHERE email='$email' AND md5(pass)='$pass'");
            ...
            <form action="#" method="POST">
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="password" class="form-control" name="pass" id="password" onkeyup='check();' placeholder="*********">
              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <input type="password" name="pass" class="form-control" id="confirm_password" onkeyup='check();' placeholder="*********">
                  <div class="input-group-append">
                    <span class="input-group-text">
                      <i class="mdi mdi-check-circle-outline"></i>
                    </span>
        ...
        if (isset($_POST['submit_password'])) {
          include('unit.php');
          $execute = mysqli_query($koneksi, "UPDATE akun SET pass='$_POST[pass]' WHERE email='$_POST[email]'") or die(mysqli_error($koneksi));
          if ($execute) {
